...
class NavigationFrame(ctk.CTkFrame):
    def __init__(self, parent, select_frame_callback):
        ...
        self.images = {
            ...
            "logo": ctk.CTkImage(light_image=Image.open(os.path.join(image_path, "logo.png")),
                                 dark_image=Image.open(os.path.join(image_path, "logo.png")), size=(100, 20))  # Adjust size as needed
        }
        ...
        self.logo_label.grid(row=6, column=0, padx=10, pady=10, sticky="s")
    ...
    def create_buttons(self):
        ...
        self.buttons["home"] = ctk.CTkButton(self, text="Home", image=self.images["home"], fg_color="transparent", 
        ...
        self.buttons["send_email"] = ctk.CTkButton(self, text="Send Email", image=self.images["send_email"], fg_color="transparent",
                                                   text_color=("gray10", "gray90"), hover_color=("dodgerblue", "blue2"), 
                                                   anchor="w", command=lambda: self.select_frame_callback("send_email"))
        self.buttons["send_email"].grid(row=2, column=0, sticky="ew")

        self.buttons["analysis"] = ctk.CTkButton(self, text="Analysis", image=self.images["analysis"], fg_color="transparent",
                                                 text_color=("gray10", "gray90"), hover_color=("dodgerblue", "blue2"), 
                                                 anchor="w", command=lambda: self.select_frame_callback("analysis"))
        self.buttons["analysis"].grid(row=3, column=0, sticky="ew")

        self.buttons["dashboard"] = ctk.CTkButton(self, text="Dashboard", image=self.images["dashboard"], fg_color="transparent",
                                                  text_color=("gray10", "gray90"), hover_color=("dodgerblue", "blue2"), 
